...
class Generator:
    ...
    def generate_chicago(self, sparsity):
        ...
        '''
        g_path = os.path.join(self.fm.get_all_experiments_data_path(), "chicago_g_new.pkl")
        ...
        filtered_orders = []
        with open(os.path.join(self.fm.get_all_experiments_data_path(), "mapped_orders_fixed.csv"), "r") as csvfile:
        ...
        # generate drivers
        with open(os.path.join(self.fm.get_all_experiments_data_path(), "mapped_drivers_fixed.pkl"), "rb") as f:
            drivers = pkl.load(f)
